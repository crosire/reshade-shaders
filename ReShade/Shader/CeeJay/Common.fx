...
#define CeeJay_SETTINGS_DEF "ReShade/Shader/CeeJay.cfg"
#define CeeJay_SETTINGS_UNDEF "ReShade/Shader/CeeJay.undef" 
...
texture areaTex < string source = "ReShade/Shader/CeeJay/Textures/SMAA_AreaTex.dds"; >
{
	Width = 160;
	Height = 560;
	Format = R8G8;
...
texture searchTex < string source = "ReShade/Shader/CeeJay/Textures/SMAA_SearchTex.dds"; >
{
	Width = 64;
	Height = 16;
	Format = R8;
...
#if (USE_LEVELS == 1)
  #include "ReShade\Shader\CeeJay\SharedShader\Levels.h"
  #define CeeJay_SHARED 1
#endif

#if (USE_TECHNICOLOR == 1)
  #include "ReShade\Shader\CeeJay\SharedShader\Technicolor.h"
  #define CeeJay_SHARED 1
#endif

#if (USE_TECHNICOLOR2 == 1)
  #include "ReShade\Shader\CeeJay\SharedShader\Technicolor2.h"
  #define CeeJay_SHARED 1
#endif

#if (USE_DPX == 1)
  #include "ReShade\Shader\CeeJay\SharedShader\DPX.h"
  #define CeeJay_SHARED 1
#endif

#if (USE_MONOCHROME == 1)
  #include "ReShade\Shader\CeeJay\SharedShader\Monochrome.h"
  #define CeeJay_SHARED 1
#endif

#if (USE_COLORMATRIX == 1)
  #include "ReShade\Shader\CeeJay\SharedShader\ColorMatrix.h"
  #define CeeJay_SHARED 1
#endif

#if (USE_LIFTGAMMAGAIN == 1)
  #include "ReShade\Shader\CeeJay\SharedShader\LiftGammaGain.h"
  #define CeeJay_SHARED 1
#endif

#if (USE_TONEMAP == 1)
  #include "ReShade\Shader\CeeJay\SharedShader\Tonemap.h"
  #define CeeJay_SHARED 1
#endif

#if (USE_VIBRANCE == 1)
  #include "ReShade\Shader\CeeJay\SharedShader\Vibrance.h"
  #define CeeJay_SHARED 1
#endif

#if (USE_CURVES == 1)
  #include "ReShade\Shader\CeeJay\SharedShader\Curves.h"
  #define CeeJay_SHARED 1
#endif

#if (USE_SEPIA == 1)
  #include "ReShade\Shader\CeeJay\SharedShader\Sepia.h"
  #define CeeJay_SHARED 1
#endif

#if (USE_FILMICPASS == 1)
  #include "ReShade\Shader\CeeJay\SharedShader\FilmicPass.h"
  #define CeeJay_SHARED 1
#endif

#if (USE_REINHARDLINEAR == 1)
  #include "ReShade\Shader\CeeJay\SharedShader\ReinhardLinear.h"
  #define CeeJay_SHARED 1
#endif

#if (USE_NOSTALGIA == 1)
  #include "ReShade\Shader\CeeJay\SharedShader\Nostalgia.h"
  #define CeeJay_SHARED 1
#endif

#if (USE_VIGNETTE == 1)
  #include "ReShade\Shader\CeeJay\SharedShader\Vignette.h"
  #define CeeJay_SHARED 1
#endif

#if (USE_FILMGRAIN == 1)
  #include "ReShade\Shader\CeeJay\SharedShader\FilmGrain.h"
  #define CeeJay_SHARED 1
#endif

#if (USE_DITHER == 1)
  #include "ReShade\Shader\CeeJay\SharedShader\Dither.h"
  #define CeeJay_SHARED 1
#endif

#if (USE_BORDER == 1)
  #include "ReShade\Shader\CeeJay\SharedShader\Border.h"
  #define CeeJay_SHARED 1
#endif

#if (USE_SPLITSCREEN == 1)
  #include "ReShade\Shader\CeeJay\SharedShader\Splitscreen.h"
  #define CeeJay_SHARED 1
#endif
...
#define CeeJay_PIGGY_COUNT_PING (USE_ASCII + USE_CARTOON + USE_EXPLOSION + USE_CA + USE_ADVANCED_CRT + USE_PIXELART_CRT + USE_BLOOM + USE_HDR + USE_LUMASHARPEN + USE_LENS_DISTORTION + USE_SMAA + USE_FXAA - 1)
  ...
  #include "ReShade\Shader\CeeJay\SMAA.h"
#endif
  ...
  #include "ReShade\Shader\CeeJay\Fxaa3_11.h"
#endif
