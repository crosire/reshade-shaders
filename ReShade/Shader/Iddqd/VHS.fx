#include "ReShade/Shader/Iddqd.cfg"
...
#if (sNoiseMode == 1)
texture texnoise2  < string source = "ReShade/Shader/Iddqd/Textures/VHS_N1.jpg";  > {Width = BUFFER_WIDTH; Height = BUFFER_HEIGHT; Format = RGBA8;};
#elif (sNoiseMode == 2)
texture texnoise2  < string source = "ReShade/Shader/Iddqd/Textures/VHS_N2.jpg";  > {Width = BUFFER_WIDTH; Height = BUFFER_HEIGHT; Format = RGBA8;};
#else
texture texnoise2  < string source = "ReShade/Shader/Iddqd/Textures/VHS_N3.jpg";  > {Width = BUFFER_WIDTH; Height = BUFFER_HEIGHT; Format = RGBA8;};
#endif
...
#include "ReShade/Shader/Iddqd.undef"
