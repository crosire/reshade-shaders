#include "Common.fx"
#include "ReShade/Shader/Ganossa/Common.fx"
...
texture   texHeat   < string source = "ReShade/Shader/MartyMcFly/Textures/mcheat.png";   > {Width = 512;Height = 512;Format = RGBA8;};
...
#include Ganossa_SETTINGS_DEF
#if AL_HeatHazeControle && USE_AMBIENT_LIGHT
	#include "ReShade/Shader/Ganossa/HeatHazeControle.fx"
#else	
