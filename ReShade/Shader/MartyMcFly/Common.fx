...
#define MartyMcFly_SETTINGS_DEF "ReShade/Shader/MartyMcFly.cfg"
#define MartyMcFly_SETTINGS_UNDEF "ReShade/Shader/MartyMcFly.undef" 
...
{
//textures
texture2D texNoise      < string source = "ReShade/Shader/MartyMcFly/Textures/mcnoise.png"; > {Width = BUFFER_WIDTH;Height = BUFFER_HEIGHT;Format = RGBA8;};
