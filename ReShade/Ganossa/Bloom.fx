...
texture   texDirt   < string source = "ReShade/Ganossa/Textures/" lensDirtTex ;   > {Width = BUFFER_WIDTH;Height = BUFFER_HEIGHT;Format = RGBA8;};
...
texture   texSprite < string source = "ReShade/Ganossa/Textures/Ganossa_sprite.png"; > {Width = BUFFER_WIDTH;Height = BUFFER_HEIGHT;Format = RGBA8;};
