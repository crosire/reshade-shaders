#pragma once
	...
	#define __RESHADE_DEPTH_LINEARIZATION_FAR_PLANE_DEFAULT__ 1000.0
	#define __RESHADE_DEPTH_INPUT_IS_UPSIDE_DOWN_DEFAULT__ 0
	#define __RESHADE_DEPTH_INPUT_IS_REVERSED_DEFAULT__ 0
	#define __RESHADE_DEPTH_INPUT_IS_LOGARITHMIC_DEFAULT__ 0
#else
	#define __RESHADE_DEPTH_LINEARIZATION_FAR_PLANE_DEFAULT__ 1000.0
	#define __RESHADE_DEPTH_INPUT_IS_UPSIDE_DOWN_DEFAULT__ 0
	#define __RESHADE_DEPTH_INPUT_IS_REVERSED_DEFAULT__ 1
	#define __RESHADE_DEPTH_INPUT_IS_LOGARITHMIC_DEFAULT__ 0
#endif
